...
const VerifikasiList = () => {
  const { data, setData, setStep, isFileUploaded } = useContext(VerifikasiContext);
  ...
  useEffect(() => {
    // Cek apakah semua form telah diisi dan file surat keterangan diunggah
    const isValid = (
      namaLengkap &&
      nik &&
      tanggalLahir &&
  ...
  const handleFormSubmit = (e) => {
    ...
    // Periksa apakah semua form telah diisi
    if (isFormValid) {
      ...
      // Jika ada form yang belum diisi, tampilkan pesan kesalahan atau lakukan tindakan lainnya
  ...
  return (
    <div className="verifikasi-list">
      ...
      <form onSubmit={handleFormSubmit}>
        <div className="grid-container">
          ...
          <div className="grid-item">
            ...
            <select value={kodeTipeDisabilitas} onChange={handleKodeTipeDisabilitasChange} required>
              ...
              <option value="3">Tipe D untuk Penyandang Disabilitas Sensorik</option>
            </select>
          </div>
          <div className="grid-item">
        ...
        <button type="submit" disabled={!isFormValid}>Terverifikasi</button>
      </form>
